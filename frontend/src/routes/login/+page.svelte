<script lang="ts">
  ...
  function enterApp() {
    localStorage.setItem('duel_session', 'mock-session');
    goto('/');
  }
</script>
...
<div class="auth-page">
  ...
  <form class="auth-form" on:submit|preventDefault={enterApp}>
    ...
    <label>Usuario o email<input type="text" placeholder="angel o tu@email.com" /></label>
